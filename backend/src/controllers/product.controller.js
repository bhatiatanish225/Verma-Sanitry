  ...
  taxPercent
    ...
    const product = await prisma.product.create({
      data: {
        ...
        originalPrice: finalOriginalPrice ? parseFloat(finalOriginalPrice) : null,
...
exports.updateProduct = async (req, res) => {
  try {
    ...
    if (finalOriginalPrice !== undefined) updateData.originalPrice = parseFloat(finalOriginalPrice);
    ...
    if (finalReviewsCount !== undefined) updateData.reviewsCount = parseInt(finalReviewsCount);
